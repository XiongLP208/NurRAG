...
def run_webui(started_event: mp.Event = None):
    ...
    p = subprocess.Popen(["streamlit", "run", "webui.py",
                          "--server.address", get_docker_internal_ip(),
                          "--server.port", str(8845),
                        #   "--theme.base", "light",
                        #   "--theme.primaryColor", "#165dff",
                        #   "--theme.secondaryBackgroundColor", "#f5f5f5",
                        #   "--theme.textColor", "#000000",
                          "--theme.base", "light",#"light",# 上面的条的颜色
                          "--theme.backgroundColor", "#2F3D5F",# 主窗口背景颜色
                          "--theme.primaryColor", "#1D93AB",#滑动条颜色"#165dff",
                          "--theme.secondaryBackgroundColor", "#192744",#sidebar颜色"#f5f5f5",
                          "--theme.textColor", "#FFFFFF", # 字体颜色
